...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # KV layer-parallel data plane. "sdma" uses TransferEngine direct writes;
    # "mte" uses MemFabric symmetric GVA and the AscendC MTE copy operator.
    "ASCEND_KVPP_TRANSPORT": lambda: os.getenv("ASCEND_KVPP_TRANSPORT", "sdma"),
    # Per-rank bounded symmetric staging capacity used only by the MTE backend.
