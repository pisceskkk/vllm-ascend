...
def _kv_cache_group(compress_ratio: int):
    return SimpleNamespace(
        kv_cache_spec=SimpleNamespace(compress_ratio=compress_ratio))
...
def test_compressed_positions_depend_on_corrected_num_computed_tokens():
    ...
    corrected_positions, corrected_req_indices, corrected_lengths = (
    ...
    np.testing.assert_array_equal(optimistic_positions[0],
